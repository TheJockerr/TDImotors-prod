...
const INSTAGRAM_URL = 'https://www.instagram.com/tdi_motors';
...
const navLinks = [
  ...
  { to: '/contacto', label: 'Consignaciones' },
];
    ...
    <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
      <nav className={`${styles.nav} container`}>
        ...
        <Link to="/" className={styles.logo}>
          <span className={styles.logoAuto}>TDI</span>
          <span className={styles.logoMotors}>Motors</span>
        </Link>
        ...
        <ul className={`${styles.links} ${menuOpen ? styles.open : ''}`}>
          ...
          {isAdmin && (
            <li className={styles.mobileAdminOnly}>
              <NavLink
                to="/admin"
                className={({ isActive }) =>
                  `${styles.link} ${styles.linkAdminMobile} ${isActive ? styles.active : ''}`
                }
              >
        ...
        <div className={styles.ctas}>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`${styles.btn} ${styles.btnTiktok}`}
            aria-label="TikTok"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
